...
<div class="container-fluid mt-5 p-3">
    <form method="POST" action={{ route('update-action', $data->id) }}
                ...
                <div class="row">
                    <div class="me-2">
                        ...
                        <input class="form-control form-control-lg" name="posisi_lamaran" type="text"
                            placeholder="posisi yang akan dilamar" aria-label="default input example" value="{{old('posisi_lamaran') ? old('posisi_lamaran'):  $data->posisi_lamaran }}" required>
                           @if($errors->any())
                ...
                <div class="row mt-5">
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="nama_lengkap" type="text" placeholder="Isi nama lengkap"
                            aria-label="default input example" value="{{old('nama_lengkap') ? old('nama_lengkap'):  $data->nama_lengkap }}" required>
                            @if($errors->any())
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="nama_panggilan" type="text" placeholder="Isi nama panggilan"
                            aria-label="default input example" value="{{old('nama_panggilan') ? old('nama_panggilan'):  $data->nama_panggilan }}" required>
                            @if($errors->any())
                ...
                <div class="row mt-2">
                    <div class="col-md-3">
                        ...
                        <input class="form-control" name="tempat_tanggal_lahir" type="text"
                            placeholder="Gresik, 19 Januari 2000" aria-label="default input example" value="{{old('tempat_tanggal_lahir') ? old('tempat_tanggal_lahir'):  $data->tempat_tanggal_lahir }}" required>
                             @if($errors->any())
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" aria-label="Default select example" name="jenis_kelamin" required>
                            ...
                            <option {{strtolower(old('jenis_kelamin')) == 'pria' ? "selected" :  ($data->jenis_kelamin == 'pria' ? "selected" : "") }}>Pria</option>
                            <option {{strtolower(old('jenis_kelamin')) == 'wanita' ? "selected":  ($data->jenis_kelamin == 'wanita' ? "selected" : "") }}>Wanita</option>
                        </select>
                        @if($errors->any())
                    ...
                    <div class="col-md-3">
                        ...
                        <input class="form-control" name="kebangsaan" type="text" placeholder="Isi kebangsaan anda"
                            name="kebangsaan" aria-label="default input example" value="{{old('kebangsaan') ? old('kebangsaan'):  $data->kebangsaan }}" required>
                            @if($errors->any())
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" aria-label="Default select example" name="agama" required>
                            ...
                            <option {{old('agama') == 'Islam' ? "selected":  ($data->agama == 'Islam' ? "selected":  "") }}>Islam</option>
                            <option {{old('agama') == 'Kristen' ? "selected":  ($data->agama == 'Kristen' ? "selected":  "") }}>Kristen</option>
                            <option {{old('agama') == 'Katolik' ? "selected":  ($data->agama == 'Katolik' ? "selected":  "") }}>Katolik</option>
                            <option {{old('agama') == 'Hindu' ? "selected":  ($data->agama == 'Hindu' ? "selected":  "") }}>Hindu</option>
                            <option {{old('agama') == 'Buddha' ? "selected":  ($data->agama == 'Buddha' ? "selected":  "") }}>Buddha</option>
                            <option {{old('agama') == 'Konghucu' ? "selected":  ($data->agama == 'Konghucu' ? "selected":  "") }}>Konghucu</option>
                        </select>
                        @if($errors->any())
                ...
                <div class="row mt-5">
                    <div class="col-md-6">
                        ...
                        <select class="form-select" aria-label="Default select example" name="pendidikan_terakhir" required>
                            ...
                            <option {{old('pendidikan_terakhir') == 'SD' ? "selected":  ($data->pendidikan_terakhir == 'SD' ? "selected":  "") }}>SD</option>
                            <option {{old('pendidikan_terakhir') == 'SMP' ? "selected":  ($data->pendidikan_terakhir == 'SMP' ? "selected":  "") }}>SMP</option>
                            <option {{old('pendidikan_terakhir') == 'SMA' ? "selected":  ($data->pendidikan_terakhir == 'SMA' ? "selected":  "") }}>SMA</option>
                            <option {{old('pendidikan_terakhir') == 'S1' ? "selected":  ($data->pendidikan_terakhir == 'S1' ? "selected":  "") }}>S1</option>
                            <option {{old('pendidikan_terakhir') == 'S2' ? "selected":  ($data->pendidikan_terakhir == 'S2' ? "selected":  "") }}>S2</option>
                            <option {{old('pendidikan_terakhir') == 'S3' ? "selected":  ($data->pendidikan_terakhir == 'S3' ? "selected":  "") }}>S3</option>
                        </select>
                        @if($errors->any())
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="jurusan" type="text" placeholder="Isi jurusan pendidikan terakhir"
                            aria-label="default input example" value="{{old('jurusan') ? old('jurusan'):  $data->jurusan }}" required>
                        @if($errors->any())
                    ...
                    <div class="col-md-6 mt-2">
                        ...
                        <input class="form-control" name="sekolah" type="text" placeholder="Isi sekolah terakhir"
                            aria-label="default input example" value="{{old('sekolah') ? old('sekolah'):  $data->sekolah }}" required>
                        @if($errors->any())
                    ...
                    <div class="col-md-6 mt-2">
                        ...
                        <input class="form-control" name="ipk" type="number" placeholder="Masukan IPK atau nilai"
                            aria-label="default input example" step="0.01" value="{{old('ipk') ? old('ipk'):  $data->ipk }}"  required>
                        @if($errors->any())
                    ...
                    <div class="col-md-12 mt-5">
                        ...
                        <textarea class="form-control" name="alamat_terakhir" placeholder="Alamat terakhir" id="floatingTextarea2"
                            style="height: 100px" required>{{old('alamat_terakhir') ? old('alamat_terakhir'):  $data->alamat_terakhir }}</textarea>
                        @if($errors->any())
               ...
               <div class="row mt-5">
                    <div class="col-md-4">
                        ...
                        <select class="form-select" aria-label="Default select example" name="kawin" required>
                            ...
                            <option {{old('kawin') === true ? "selected" : ($data->family->kawin === true ? "selected" : "")}}>Sudah</option>
                            <option {{old('kawin') === false ? "selected" : ($data->family->kawin === false ? "selected" : "")}}>Belum</option>
                        </select>
                        @if($errors->any())
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control" name="jml_saudara_kandung" type="number" placeholder="Isi jumlah saudara kandung"
                            aria-label="default input example" value="{{old('jml_saudara_kandung') ? old('jml_saudara_kandung'):  $data->family->jml_saudara_kandung }}" required>
                        @if($errors->any())
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control" name="jml_anak" type="number" placeholder="Isi jumlah anak"
                            aria-label="default input example" value="{{old('jml_anak') ? old('jml_anak'):  $data->family->jml_anak }}" required>
                        @if($errors->any())
                ...
                <div class="row mt-5">
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="nama_ayah" type="text" placeholder="Isi nama ayah"
                            aria-label="default input example" value="{{old('nama_ayah') ? old('nama_ayah'):  $data->family->jml_anak }}" required>
                        @if($errors->any())
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="nama_ibu" type="text" placeholder="Isi nama ibu"
                            aria-label="default input example" value="{{old('nama_ibu') ? old('nama_ibu'):  $data->family->nama_ibu }}" required>
                        @if($errors->any())
                ...
                <div class="row mt-2">
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="pekerjaan_ayah" type="text" placeholder="Isi pekerjaan ayah"
                            aria-label="default input example" value="{{old('pekerjaan_ayah') ? old('pekerjaan_ayah'):  $data->family->pekerjaan_ayah }}" required>
                         @if($errors->any())
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="pekerjaan_ibu" type="text" placeholder="Isi pekerjaan ibu"
                            aria-label="default input example" value="{{old('pekerjaan_ibu') ? old('pekerjaan_ibu'):  $data->family->pekerjaan_ibu }}" required>
                        @if($errors->any())
